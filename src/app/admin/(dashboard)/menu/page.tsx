...
export default async function AdminMenuPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <div>
          <label className="text-xs font-medium text-neutral-600">Шинэ ангилалын нэр</label>
          <input
            name="name"
            required
        ...
        <div>
          <label className="text-xs font-medium text-neutral-600">Эрэмбэ</label>
          <input
            name="sort_order"
            type="number"
            defaultValue={categories.length + 1}
            className="mt-1 block w-20 rounded-lg border border-neutral-300 px-3 py-1.5 text-sm"
          />
        </div>
        ...
        <div key={category.id} className="space-y-3 rounded-2xl border border-neutral-200 bg-white p-4">
          ...
          <div className="space-y-2">
            ...
            {category.items.length === 0 && (
              <p className="text-sm text-neutral-500">Одоогоор хоол алга байна.</p>
            )}
          </div>
          ...
          >
            ...
            <input
              ...
              className="rounded-lg border border-neutral-300 px-2 py-1.5 text-sm md:col-span-1"
            />
            <input
              name="price"
              type="number"
            ...
            <input
              name="description"
              placeholder="Тайлбар"
              className="rounded-lg border border-neutral-300 px-2 py-1.5 text-sm md:col-span-2"
            />
            <input
              name="image_url"
